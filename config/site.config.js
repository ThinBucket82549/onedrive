...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'jake.redward@education.nsw.gov.au',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/thinbucket82549',
    },
    {
      name: 'Telegram',
      link:'',
